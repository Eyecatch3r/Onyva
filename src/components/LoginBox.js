            ...
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    <label className="form-control w-full max-w-xs">
                        ...
                        <input type="email" className="input input-bordered w-full max-w-xs" placeholder="E-Mail" value={email} onChange={(e) => setEmail(e.target.value)} />
                    </label>
                    <label className="form-control w-full max-w-xs">
                        <div className="label">
                ...
                {error && <div role="alert" className="alert alert-error mb-3 mx-2 w-auto">
